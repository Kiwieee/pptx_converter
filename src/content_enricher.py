...
This module uses Google Gemini to add supplementary information,
examples, statistics, and context to slide narrations based on
the selected enrichment level.
